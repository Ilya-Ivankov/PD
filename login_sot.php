...
<body>
    <div id="log">
        <form action="" method="post">
            <h1>Вход</h1>
            <div>
                <input type="email" name="email" id="email" placeholder="Введите логин" style="width: 250px">
            </div>
            <div>
                <input type="password" name="password" id="password" placeholder="Введите пароль" style="width: 250px">
            </div>
			<div>
		...
		<option value="std">Студент</option>
            ...
            <div class="lbut">
                ...
                <input type="button" value="Регистрация" onclick="window.location='register.php'" class="bg-dark">
            </div>
			<?php
	if(isset($fmsg)){
?>		
